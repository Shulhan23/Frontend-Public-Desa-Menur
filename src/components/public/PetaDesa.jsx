...
export default function PetaDesa() {
  ...
  return (
    <div className="w-full mt-4 text-center relative z-10">
      {showHint && (
        <p className="absolute top-2 left-1/2 transform -translate-x-1/2 bg-white bg-opacity-80 text-sm text-gray-800 px-4 py-1 rounded shadow z-20">
